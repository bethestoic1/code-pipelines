# BrainGrid affiliate — codepipelines.com

## Creator link (live)

- **Affiliate URL:** `https://braingrid.link/stoic`
- **Site:** https://codepipelines.com/

This link is in use in:
- **Homepage** — `index.html` (footer)
- **Blog index** — `blog/index.html` (footer CTA)
- **All 28 blog articles** — CTA box “Ship faster with your stack” plus every inline mention of BrainGrid in body copy (affiliate-linked for maximum referral potential)
- **Generator** — `scripts/generate_articles.py` (future articles get the same CTA and link)

No further link replacement needed. For new posts, keep the same CTA: “We recommend BrainGrid for Cursor/Claude Code users. [Try BrainGrid →]” with `https://braingrid.link/stoic`.

---

## Affiliate audit (Apex Affiliate Oracle)

**Pain points → Trends → Top affiliate plays → Strategy → Projection**

### Pain points (audience: DevEx / AI-native devs)

| # | Pain point | Monetization angle |
|---|------------|---------------------|
| 1 | “Which AI coding tool?” (Cursor vs Copilot vs Claude vs Windsurf) | Comparison content → BrainGrid (Cursor/Claude stack) |
| 2 | “Vibe coding” vs architectural integrity | Diff-based workflows, specs → BrainGrid (planning before code) |
| 3 | Credit/pricing confusion (Cursor credits, Copilot seats) | “Cursor pricing 2026”, cost comparisons → BrainGrid as complement |
| 4 | Onboarding / time-to-first-commit | Context, docs, MCP → BrainGrid (specs/tasks for agents) |
| 5 | Multi-agent vs single-agent, orchestration | Authority content → BrainGrid (task breakdown for agents) |
| 6 | Security in pipelines (secrets, deps) | DevSecOps articles → later Snyk/GitGuardian if you join |

### 2026 trends / money flow

- Agentic and multi-agent adoption; credit-based pricing; enterprise buying.
- BrainGrid targets Cursor/Claude Code users; 15% recurring (creator program); 60-day cookie.
- Same audience already on the site: “best AI coding tool”, “cursor vs X”, “devex stack”, “agentic workflows”.
...
- **BrainGrid:** 10 referrals/mo at ~$20/mo plan × 15% ≈ **$30/mo**; scales with traffic.  
- **12‑month goal:** 500–2K organic sessions/mo → 20–50 referrals/mo → **$100–400/mo** recurring if content and CTAs stay consistent.
...
## Content to support (what to add/expand)

### Tier 1 — Highest intent (expand first)

| Article | Status | Action |
|---------|--------|--------|
| Cursor vs Copilot 2026 | Has table + CTA | Expand “Pricing”, “Agentic workflows”, “Our take”; add internal links. |
| Best AI coding assistant 2026 | Scaffolded | Full comparison (Cursor, Claude Code, Windsurf, Tabnine, Copilot); “Best for X”; 1.5–2k words. |
| Cursor pricing 2026 | Scaffolded | Credits, plans, hidden costs, “how to reduce burn”; BrainGrid as complement. |
| Claude Code vs Cursor Agent | Scaffolded | Hands-on comparison; when to use which; BrainGrid in CTA. |
| Windsurf vs Cursor vs Claude Code 2026 | Scaffolded | Same pattern; BrainGrid for Cursor/Claude users. |
| Tabnine vs Cursor vs Copilot | Scaffolded | Compliance vs agentic; BrainGrid + Tabnine where relevant. |

### Tier 2 — Authority (expand next)

- DevEx stack 2026, Best agentic coding tools, Agentic workflows Cursor Claude, Multi-agent coding, Diff-based workflows, Cursor Agent vs Claude Code CLI.

### Tier 3–6

- How-tos (onboarding, ship faster, AI dev stack, VS Code extensions, pair programming).  
- Security/CI/CD (secret scanning, dependency scanning, DevSecOps) when you have or plan Snyk/GitGuardian.  
- Hosting (best hosting for developers, deploy AI apps) when you have Kinsta/Cloudways.

**Format for every expanded post:** Intro → comparison or steps → “Our take” / “Best for X” → CTA box (already present with BrainGrid). Length: 1,500–2,500 words for comparisons; 1,000+ for how-tos.

---

## Where we recommend BrainGrid (reference)

| Place | Copy |
|-------|------|
| Homepage footer | “Tool we recommend for Cursor/Claude Code users: BrainGrid.” (linked) |
| Every blog CTA box | “Ship faster with your stack: We recommend BrainGrid for Cursor and Claude Code users. Try BrainGrid →” (both links = braingrid.link/stoic) |
| Blog index footer | Same as homepage: “Tool we recommend for Cursor/Claude Code users: BrainGrid.” (linked) |
| Inline body mentions | Every contextual mention of BrainGrid in article body copy links to braingrid.link/stoic to maximize referral clicks. |

Future articles: same CTA box; generator already uses the affiliate link.

---

## Replit referral (use when relevant)
